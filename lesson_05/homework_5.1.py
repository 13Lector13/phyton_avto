...
# ( year >= 2017 , engine_volume >= 1.6, price <= 36000)

def find_car():
    return {car_name: car_info for car_name, car_info in car_data.items() if car_info[1] >= 2017 and car_info[2] >= 1.6 and car_info[4] <= 36000}

special_cars = dict(list(sorted(find_car().items(), key=lambda item: item[1][4]))[:5])
print(special_cars)
