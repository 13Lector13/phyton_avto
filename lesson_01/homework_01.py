...
trees = apples_tree + pear_tree + plum_tree
print(trees)
print(f"Всего посадили: {trees} деревьев")
# task 08
"""
...
temp_2 = temp_1 - 10
temp_3 = temp_2 + 4
print(f"Температура надвечір: {temp_3}")
...
print(f"Дітей у театральному гуртку: {childrens}")
